        ...
        <>
            ...
            <main className="h-screen flex justify-center bg-[#FFE0EE]">
                <section className="flex flex-col justify-center items-center w-[900px] h-[550px] mt-8 bg-white rounded-lg shadow-md">
                    <h1 className="font-bold text-[1.8rem] text-[#1F2937]">
                        Painel Administrativo
                    </h1>
                    <p className="text-[#4b5563] mb-7">
                        ...
                        <div className="flex gap-4 w-full">
                            <div className="flex-1 flex flex-col gap-2">
                                ...
                                <input 
                                    ...
                                    id="nomeProduto" 
                                    required 
                                    className="w-full border border-gray-300 rounded-lg text-gray-600 text-sm py-2.5 px-3 focus:outline-none focus:ring-1 focus:ring-gray-200"
                                />
                            </div>
